...
echo "  ✓ Adaptive report length (Brief/Standard/Deep)"
echo "  ✓ Evidence snippet repair chains"
echo "  ✓ Confidence scoring and reporting"
echo "  ✓ Last-mile backfill optimization"
echo "  ✓ Singleton whitelisting for authorities"
echo ""
echo "Previous Improvements:"
echo "  ✓ Unified architecture & deduplication"
echo "  ✓ HTML cleaning & citation validation"
echo "  ✓ Triangulation consistency"
echo "  ✓ Pack-aware primary detection"
echo ""
